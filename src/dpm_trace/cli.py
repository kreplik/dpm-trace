...
# %dpm is the binary when the runner supplies one, otherwise the Python module.
# The binary form is what remains once the Python implementation is retired.
dpm = os.environ.get("DPM_TRACE_IT_DPM") or (python + " -m dpm_trace.cli")
